...
import { Eye, EyeOff, Mail, Lock, User, Phone, Heart, ArrowRight, Shield, Award } from 'lucide-react';

const Register = () => {
  const [showPassword, setShowPassword] = useState(false);
  const [showConfirmPassword, setShowConfirmPassword] = useState(false);
  const [isLoading, setIsLoading] = useState(false);
  const [selectedRole, setSelectedRole] = useState('needy');
  ...
  const roles = [
    {
      id: 'needy',
      title: 'I Need Help',
      description: 'Create help requests and connect with volunteers',
      icon: Heart,
    ...
    },
    {
      ...
      description: 'Volunteer to assist others in your community',
      icon: Award,
                    ...
                    >
                      <div className="flex items-center">
                        <Icon className={`w-5 h-5 mr-3 ${
                          selectedRole === role.id
                            ? role.id === 'needy' ? 'text-blue-600' : 'text-green-600'
                            : 'text-gray-400'
                        }`} />
                        <div>
